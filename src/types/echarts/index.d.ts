...
declare namespace echarts {
    ...
    /**
     * Connects interaction of multiple echart series. For example:
     *
     *
     * @param group Group id in string, or array of echart instance.
     */
    function connect(group: string | ECharts[]): void

    /**
     * Disconnects interaction of multiple echart series. To have one single
     * instance to be removed, you can set `group` of echart instance to be null.
     *
    ...
    /**
     * Destroys echart instance, after which the instance cannot be used any
     *     more.
     *
     ...
     * [initialize the echart instance](https://echarts.apache.org/api.html#echarts.init).
     *
    ...
    interface ECharts {
        /**
         * Group name to be used in echart connection
         */
        group: string
         ...
         *     new parameters and data, and then refresh echart.
         *
        ...
        /**
         * Resizes echart, which should be called manually when container size
        ...
        /**
         * Triggers echart action, like echart switch `legendToggleSelect`,
         ...
         *     element in the echart, the other kind will be triggered after
         ...
         */
        convertToPixel(finder: string, value: string | any[])
            : string | any[]
         ...
         * @param {string | any[]} value The value to be converted.
         */
        convertFromPixel(finder: string, value: any[] | string)
            : any[] | string
        ...
        /**
         * Exports echart image; returns a base64 URL; can be set to `src` of
         *      `Image`.
         *
         * @param opts Options.
         */
        ...
        /**
         * Exports connected echart image; returns a base64 url; can be set to
